...
public interface IRoutedItem {
    ...
    boolean getIsLostItem();

    void setIsLostItem(boolean bool);

    void setAdditionalSourceInformation(IAdditionalTargetInformation info);

    IAdditionalTargetInformation getAdditionalSourceInformation();
    ...
    int getSourceRouterID();

    void setSourceRouterID(int newID);
